        ...
        <div className="flex flex-col gap-2 rounded-xl2 border border-life/40 bg-life-soft p-3.5">
          ...
          <div className="flex flex-col gap-2">
            {pending.map((action) => (
              <div
                key={action.id}
                className="flex items-center justify-between gap-2 rounded-xl border border-paper-border bg-paper-surface px-3 py-2.5 shadow-paper"
              >
                <span className="min-w-0 flex-1 text-[13px] text-paper-ink">{action.describeText}</span>
